document.addEventListener('DOMContentLoaded', function () {
    ...
    // Initialiser le style display de la pop-up et des boutons
    ...
    document.getElementById('afficheFiltre').addEventListener('click', function () {
        console.log(contenu.style.display)
        ...
        if (contenu.style.display === 'none') {
            ...
            popup.style.display = 'none';
            filter.src = "../../TMAX/projet/svg/ico_config_hover.svg";
            search.style.display = 'block';
        } else {
            contenu.style.display = 'none';
            filtrelabel.style.color = "black";
            popup.style.display = 'none';
            filter.src = "../../TMAX/projet/svg/ico_config.svg";
